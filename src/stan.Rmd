...
All variables in Stan are static, meaning that they can't change from integer to real or from vector to matrix in the middle of the program. You need to be careful Stan has real and int 

...
I like Stan, however, not for its speed, but for the more logical layout. Both BUGS and jags create a directed acyclic graph, and the order of the statements in BUGS and jags is not important.
